                    ...
                    <form  method="post" action="{{url('fileManagment/fileManagment-division-update')}}" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                               ...
                               <input type="text" class="form-control" name="file_name" value="<?php print_r($file_details->file_name) ?>" readonly>
                           ...
                           <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="division" value="<?php print_r($file_details->division) ?>">
                            </div>
                         </div>
                         <div class="col-md-4">
                            <div class="form-group">
                              <label>Employee Name</label>
                              <input type="text" class="form-control" name="emp_name" value="<?php print_r($file_details->emp_name) ?>" readonly>
                            </div>
                         </div>
                           <div class="col-md-4">
                            <div class="form-group">
